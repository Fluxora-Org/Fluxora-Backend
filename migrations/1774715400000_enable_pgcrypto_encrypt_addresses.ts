...
export async function up(pgm: MigrationBuilder): Promise<void> {
  ...
  pgm.createIndex('streams', 'sender_address_hash', { ifNotExists: true });
  pgm.createIndex('streams', 'recipient_address_hash', { ifNotExists: true });
...
export async function down(pgm: MigrationBuilder): Promise<void> {
  pgm.dropIndex('streams', 'recipient_address_hash', { ifExists: true });
  pgm.dropIndex('streams', 'sender_address_hash', { ifExists: true });
  pgm.dropColumns('streams', ['recipient_address_hash', 'sender_address_hash'], { ifExists: true });
